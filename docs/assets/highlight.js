			...
			(function e(n, t) {
				for (var r = n.firstChild; r; r = r.nextSibling)
					3 === r.nodeType
						...
						: 1 === r.nodeType && (a.push({ event: "start", offset: t, node: r }), (t = e(r, t)), d(r).match(/br|hr|img|input/) || a.push({ event: "stop", offset: t, node: r }));
				return t;
			})(e, 0),
			a
		);
					...
					: (function () {
							...
							for (r = "", n = 0, E.lR.lastIndex = 0, t = E.lR.exec(R); t; )
								(r += _(R.substring(n, t.index))),
									...
									(e = a.k.hasOwnProperty(c) && a.k[c]) ? ((d += e[1]), (r += u(e[0], _(t[0])))) : (r += _(t[0])),
									(n = E.lR.lastIndex),
									(t = E.lR.exec(R));
	...
	return {
		...
		c: [
			...
			{ bK: "new throw return else", r: 0 },
			{
				...
				eE: !0,
				k: a,
				c: [{ b: e.UIR + "\\s*\\(", rB: !0, r: 0, c: [e.UTM] }, { cN: "params", b: /\(/, e: /\)/, k: a, r: 0, c: [e.ASM, e.QSM, e.CNM, e.CBCM] }, e.CLCM, e.CBCM]
			},
			t,
			{ cN: "meta", b: "@[A-Za-z]+" }
		]
