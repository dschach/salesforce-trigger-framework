  ...
  function V(e) {
    ...
    return (
      ...
      (function n(r, o) {
        ...
        [T, D, F, P].forEach((e) => e(r, o)), e.compilerExtensions.forEach((e) => e(r, o)), (r.__beforeBegin = null), [L, B, H].forEach((e) => e(r, o)), (r.isCompiled = !0);
        let c = null;
        return (
          'object' == typeof r.keywords && r.keywords.$pattern && ((r.keywords = Object.assign({}, r.keywords)), (c = r.keywords.$pattern), delete r.keywords.$pattern),
          (c = c || /\w+/),
...
'object' == typeof exports && 'undefined' != typeof module && (module.exports = hljs); /*! `java` grammar compiled for Highlight.js 11.5.0 */
(() => {
  var e = (() => {
    'use strict';
    var e = '\\.([0-9](_*[0-9])*)',
    ...
    return (e) => {
      const a = e.regex,
        ...
        c = { className: 'params', begin: /\(/, end: /\)/, keywords: r, relevance: 0, contains: [e.C_BLOCK_COMMENT_MODE], endsParent: !0 };
      return {
        name: 'Java',
        aliases: ['jsp'],
        keywords: r,
        ...
        contains: [
          ...
          { begin: [/record/, /\s+/, t], className: { 1: 'keyword', 3: 'title.class' }, contains: [c, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE] },
          {
